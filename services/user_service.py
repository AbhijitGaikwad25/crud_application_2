...
def get_user_service(user_id):
    try:
        ...
        return {"message": "Error retrieving user: " + str(e)}, 500
...
def get_all_users_service():
    try:
        ...
        return {"message": "Error retrieving users: " + str(e)}, 500
...
def delete_user_service(user_id):
    try:
        ...
        return {"message": "Error deleting user: " + str(e)}, 500
...
def update_user_service(user_id, data):
    try:
        ...
        return {"message": "Error updating user: " + str(e)}, 500